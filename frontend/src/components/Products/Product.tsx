...
export default function Products({ limit }: ProductsProps) {
  ...
  if (loading)
    return <div className="text-center text-[#A2CD04] py-20">Loading...</div>;
  if (error)
    return <div className="text-center text-[#A2CD04] py-20">{error}</div>;
  if (!products.length)
    return (
      <div className="text-center text-[#A2CD04] py-20">
    ...
    <div className="bg-black min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-lg text-gray-300">
          High-quality fitness equipment and supplements to enhance your workout
        </p>
      </div>
          ...
          >
            ...
            <div className="p-6 flex flex-col justify-between flex-1">
              ...
              <div className="flex justify-between items-center mt-4">
                <span className="text-2xl font-bold text-[#A2CD04]">
                  ₹{p.price}
                </span>
